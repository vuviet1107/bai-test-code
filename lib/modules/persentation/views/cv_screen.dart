...
import 'package:untitled/common/custom_scaffold.dart';
import 'package:untitled/common/will_unfocus_form_scope.dart';
...
import 'package:untitled/modules/persentation/views/add_document.dart';
...
class CvScreen extends GetView<CvController> {
                  ...
                  Column(
                    children: [
                      ...
                      Stack(
                        children: [
                          PillTextField12(
                            prefixIcon: const SizedBox(width: 56),
                      ...
                      Row(
                        ...
                        children: [
                          InkWell(
                            onTap: () =>
                            controller.listDocument.last!
                                .textSymbolsTEC.text.isNotEmpty &&
  ...
  Widget buildSheetGender(BuildContext context) =>
      Obx(
            () =>
            Column(
